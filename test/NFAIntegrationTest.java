...
public class NFAIntegrationTest {
  ...
  public void shouldReturnTrueIfStringIsAccepted() throws Exception {
    String jsonString ="{\"name\":\"0*1* or 1*0*\"," +
      "\"type\":\"nfa\",\"tuple\":{\"states\":[\"q1\",\"q3\",\"q2\",\"q5\",\"q4\"]," +
      "\"alphabets\":[\"1\",\"0\"]," +
      "\"delta\":{\"q1\":{\"e\":[\"q2\",\"q4\"]},\"q2\":{\"0\":[\"q2\"],\"e\":[\"q3\"]},\"q3\":{\"1\":[\"q3\"]},\"q4\":{\"1\":[\"q4\"],\"e\":[\"q5\"]},\"q5\":{\"0\":[\"q5\"]}}," +
      "\"start-state\":\"q1\"," +
      "\"final-states\":[\"q3\",\"q5\"]}," +
      "\"pass-cases\":[\"\", \"1100\",\"1100\"]," +
  ...
  private void testCases(FiniteAutomata nfa, ArrayList<String> passCases, ArrayList<String> failCases) {
    ...
    for (String failCase : failCases) {
      ...
      System.out.println("passes  " +  nfa.verify(arrayList));
      Assert.assertFalse(nfa.verify(arrayList));
    }
  }
}
